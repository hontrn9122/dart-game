...
public class Dart : MonoBehaviour
{
    ...
    void Start()
    {
        aRSession = GameObject.FindGameObjectWithTag("AR Session Origin").GetComponent<XROrigin>();
        ARCam = aRSession.transform.Find("Camera Offset").transform.Find("Main Camera").gameObject;
